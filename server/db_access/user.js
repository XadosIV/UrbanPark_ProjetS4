...
function GetUsers(callback, infos){
	sql = `SELECT id, first_name, last_name, email, id_spot, role FROM ${dbName}.User WHERE id LIKE :id AND email LIKE :email AND role LIKE :role AND last_name LIKE :last_name AND first_name LIKE :first_name `;
	if (infos.id_spot) {

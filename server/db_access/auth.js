...
/**
 * GetHash
 * Crypt in sha256 the given parameter
 * 
 * @param {string} code
 * @returns {string} hash
 */
function GetHash(code){
	...
	return Buffer.from(createHash('sha256').update(code).digest('hex')).toString('base64');
}
...
module.exports = {GenerateNewToken, GetToken, HasPermission, GetHash};